        ...
        <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="javascript:void(0);">Add Case Studies</a></li>
                </ol>
            </div>
        </div>
        <!-- Form -->
            ...
            <div class="row">
                <div class="col-md-4 mb-2">
                    <div class="form-group">
                        ...
                        <div class="shadow-sm text-center p-3" data-append="overview_image"></div>
                ...
                <div class="col-md-4 mb-2">
                    <div class="form-group">
                        ...
                        <div class="shadow-sm text-center p-3" data-append="banner_image"></div>
            ...
            <div class="row">
                <div class="col-12 mb-2">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="overview" id="overview" required rows="12"></textarea>
                    </div>
            ...
            <div class="row">
                <div class="col-12 mb-2">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="description" id="description" required rows="12"></textarea>
                    </div>
