        ...
        <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="javascript:void(0);">Add Startup</a></li>
                </ol>
            </div>
        </div>
            <!-- Form -->
            <form class="bg-white p-4" name="startup" method="POST" action="/admin/startup/add" enctype="multipart/form-data">
                ...
                <div class="row mb-4">
                    <div class="col-md-12">
                        ...
                        <div class="shadow-sm text-center p-3" data-append="image"></div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control" name="description" required id="description" rows="12"></textarea>
